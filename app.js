...
(function() {
  var Character, Enemy, Table, Tree, Trees, char, enemy, logString, roundom, stdin, table, trees;
  ...
  Enemy = (function() {
    ...
    Enemy.prototype.draw = function() {
      ...
      this.move();
      this.edgeDetection();
      return table.set(this.x, this.y, 'ఈ');
    };

    Enemy.prototype.edgeDetection = function() {
    ...
    Enemy.prototype.move = function(input) {
      this.y -= 1;
      return this.x += 1;
    };
